...
public class LabTestBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edcontact = findViewById(R.id.editTextLTBCNumber);
        edpinCode = findViewById(R.id.editTextLTBPinCode);
        btnLTBBooking = findViewById(R.id.buttonLTBBooK);
        ...
        btnLTBBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.AddOrder(username, edname.getText().toString(),edaddress.getText().toString(), edcontact.getText().toString(),
                        Integer.parseInt(edpinCode.getText().toString()), date,"",
                        Float.parseFloat(price[1].toString()), "lab");
                db.RemoveCartItem(username, "lab");
